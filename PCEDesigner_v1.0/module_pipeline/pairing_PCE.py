...
class SequencePairFinder:
    ...
    def read_filter_ontarget_data(self):
        ...
        for tarID, tar_info_lst in self.pamInfo_dict.items():
            tarStrand, tarSeq, tarGC, tarPos = tar_info_lst
            nested_lst.append([tarID, tarPos, tarStrand, tarSeq, tarGC])
    ...
    def find_ontarget_pairs(self):
        ...
        for i in range(len(self.sorted_pamInfo)):
            for j in range(i + 1, len(self.sorted_pamInfo)):
                ...
                gc1 = self.sorted_pamInfo[i][4]
                gc2 = self.sorted_pamInfo[j][4]
                ...
                if strand1 == '+' and strand2 == '-':
                    ...
                    key = (tarID1, tarID2)
                    value = (seq1, start1, end1, strand1, gc1, off_score1, pair_len1, seq2, start2, end2, strand2, gc1, off_score2, pair_len2, distance)
